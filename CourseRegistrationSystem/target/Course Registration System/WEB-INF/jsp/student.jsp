		...
		<div class="subnavbar-inner">
			<div class="container">
				<ul class="mainnav">
					...
					<li><a href="reports.html"><i class="icon-check"></i><span>Đăng
								ký môn học</span> </a></li>
					<li><a href="guidely.html"><i class="icon-calendar"></i><span>Xem
								thời khóa biểu</span> </a></li>
					<li><a href="charts.html"><i class="icon-list-alt"></i><span>Xem
								điểm</span> </a></li>
