...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.html">Hệ thống đăng ký môn học</a>
...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="index.html"><i class="icon-user"></i><span>Trang cá nhân</span> </a> </li>
        <li><a href="reports.html"><i class="icon-group"></i><span>Quản lý thông tin giảng viên</span> </a> </li>
        <li><a href="guidely.html"><i class="icon-group"></i><span>Quản lý thông tin sinh viên</span> </a></li>
        <li><a href="charts.html"><i class="icon-th-list"></i><span>Quản lý lịch học cho từng kỳ</span> </a> </li>
        <li><a href="shortcodes.html"><i class="icon-info-sign"></i><span>Hướng dẫn</span> </a> </li>
            ...
            <div class="widget-content">
              <ul class="news-items">
                <li>
                  ...
                  <div class="news-item-detail"> <a href="http://www.c.com/thursday-roundup-40/" class="news-item-title" target="_blank">Thursday Roundup # 40</a>
                ...
                <li>
                  ...
                  <div class="news-item-detail"> <a href="http://www.c.com/retina-ready-responsive-app-landing-page-website-template-app-landing/" class="news-item-title" target="_blank">Retina Ready Responsive App Landing Page Website Template – App Landing</a>
                ...
                <li>
                  ...
                  <div class="news-item-detail"> <a href="http://www.c.com/open-source-jquery-php-ajax-contact-form-templates-with-captcha-formify/" class="news-item-title" target="_blank">Open Source jQuery PHP Ajax Contact Form Templates With Captcha: Formify</a>
